...
void draw() {
  ...
  // règle générale, on place cette action à la fin du Draw
  if (onSauve) {
    save("rendu.jpg");
    onSauve = false;
  }

  // Exception ici faite de ne pas vouloir de rectangle semi-opaque dans la capture
  // Donc, la bande qui permet de mieux voir les glissières est apparente dans le sketch, mais jamais enregistrée
